import { IItemRelationship, IItemRelationshipFilter, IItemRelationshipChange, IItemRelationshipManager, IItemRelationshipRepository } from '../../framework/item-relationship';
import ManagerBase from '../manager-base';

const TypeRegEx = /.+/;

export class ItemRelationshipManager extends ManagerBase<IItemRelationship, IItemRelationshipFilter, IItemRelationshipChange> implements IItemRelationshipManager {
