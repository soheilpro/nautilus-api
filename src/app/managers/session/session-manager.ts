...
import { ISession, ISessionFilter, ISessionChange, ISessionManager, ISessionRepository } from '../../framework/session';
import ManagerBase from '../manager-base';

export class SessionManager extends ManagerBase<ISession, ISessionFilter, ISessionChange> implements ISessionManager {
