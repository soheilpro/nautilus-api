import { IItem, IItemFilter, IItemChange, IItemRepository } from '../../framework/item';
import { IDB } from '../../db';
import { IItemDocument } from './iitem-document';
import RepositoryBase from '../repository-base';

export class ItemRepository extends RepositoryBase<IItem, IItemFilter, IItemChange, IItemDocument> implements IItemRepository {
  constructor(db: IDB) {
    super(db);
  }
